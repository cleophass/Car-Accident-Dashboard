...
st.set_page_config(layout="wide",page_icon="🚗",
                        page_title="Data info"                 
                    )


characteristics, locations, users, vehicles = load_data(2021)
st.title("🚙 Data Presentation :car:")


st.write("Link to the dataset: https://www.data.gouv.fr/fr/datasets/bases-de-donnees-annuelles-des-accidents-corporels-de-la-circulation-routiere-annees-de-2005-a-2021/#/community-reuses")

# Section "Accident Characteristics"
st.subheader("1.1. Accident Characteristics")
with st.expander("Show all"):
    st.write("The dataset contains", characteristics.shape[0], "rows and", characteristics.shape[1], "columns.")
...
with st.expander("Show all"):
    st.write("The dataset contains", locations.shape[0], "rows and", locations.shape[1], "columns.")
    st.write("Here are the first 5 rows of the dataset:")
...
with st.expander("Show all"):
    st.write("The dataset contains", users.shape[0], "rows and", users.shape[1], "columns.")
    st.write("Here are the first 5 rows of the dataset:")
...
with st.expander("Show all"):
    st.write("The dataset contains", vehicles.shape[0], "rows and", vehicles.shape[1], "columns.")
    st.write("Here are the first 5 rows of the dataset:")
